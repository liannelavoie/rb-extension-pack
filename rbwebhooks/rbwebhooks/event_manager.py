...
from reviewboard.reviews.signals import review_request_published, review_published, reply_published
...
def connect_signals():
    review_request_published.connect(post_publish_cb)
    review_published.connect(post_publish_cb)
    reply_published.connect(post_publish_cb)
